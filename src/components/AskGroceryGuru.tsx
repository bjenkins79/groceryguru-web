      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--color-primary)] mb-6">
            Ask GroceryGuru
            <br />
            <span className="text-[var(--color-secondary-accent)]">Your new grocery assistant</span>
          </h2>
          <p className="text-lg md:text-xl text-[var(--color-primary)] opacity-80 max-w-3xl mx-auto leading-relaxed">
            Ask questions to instantly know what you need
          </p>
        </div>
          ...
          <div className="order-2 lg:order-1 flex justify-center lg:justify-end">
            <div className="relative w-72 h-[600px] bg-black rounded-[3rem] p-2 shadow-2xl overflow-visible">
              <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden relative">
                <Image
                  src="/images/AskGroceryGuru_Strawberries.png"
                  alt="Ask GroceryGuru chat showing strawberry recommendations"
                  width={288}
                  height={600}
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-start">
            <div className="space-y-10 max-w-sm">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-2xl font-semibold text-[var(--color-primary)]">Smarter lists, no extra work</h3>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-2xl font-semibold text-[var(--color-primary)]">Find what's next, fast</h3>
              </div>
            </div>
          </div>
        </div>
